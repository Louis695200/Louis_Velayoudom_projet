...
Les popups fonctionnent  grâce à : des liens avec href="#id", des div avec des id correspondants et la pseudo-classe CSS :target

# Utilisation de l'IA
J’ai utilisé l’IA de manière ponctuelle pour m’aider sur certains points techniques.
Exemples : Comprendre comment relier une carte à une popup avec les id ; Gérer la fermeture d’un popup avec href="#" et  :target ; Positionner des éléments avec flexbox et position: absolute ; Styliser un lien pour qu’il ressemble à un bouton.
